  ...
  <div class="mini-header">
    <div class="mini-content">
          ...
          <li class="nav-link-item">
            <a href="" class="link"
              ><i
                ...
                class="iconfont iconbilibili-fill"
              ></i>
              主站</a
            >
          </li>
      ...
      <div class="nav-user-center">
        <div class="user-con" v-if="user.isLogin">
          <div class="item">
          ...
          <div class="item">大会员</div>
          <div class="item">消息</div>
          <div class="item">动态</div>
          <div class="item">收藏</div>
          <div class="item">历史</div>
          <div class="item">创作中心</div>
        </div>
        <!-- <div class="user-con login"></div> -->
        <div class="user-con logout" v-else>
          <div class="item">
            <span class="name"
              ><img
          ...
          <div class="item">
            <a href="" class="name">注册</a>
          </div>
        </div>
        <div class="sendfile">投稿</div>
      </div>
    </div>
  </div>
</template>
